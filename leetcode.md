...
√7、从前序与中序遍历序列构造二叉树（ LeetCode 105 ）递归，使用哈希表快速定位，不要复制字符串

√8、路径总和 II（ LeetCode 113 ）

√9、二叉树的最近公共祖先（ LeetCode 236 ）注意递归顺序和结束条件

√10、二叉树的右视图（ LeetCode 199 ）层次遍历每一层最后一个

√11、二叉树展开为链表（ LeetCode 114 ） 原地转换迭代

√12、将有序数组转换为二叉搜索树（ LeetCode 108 ）二分切割递归

√13、把二叉搜索树转换为累加树（ LeetCode 538 ）反向中序遍历 right mid left
...
√22、找树左下角的值（ LeetCode 513 ）层次没有深度快

√23、修剪二叉搜索树（ LeetCode 669 ）注意递归方式
